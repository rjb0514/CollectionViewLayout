...
@interface ChangeViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
//    [self.collectionView deleteItemsAtIndexPaths:@[indexPath]];
    ...
    if ([self.collectionView.collectionViewLayout isKindOfClass:[RJBLineFlowLayout class]]) {
        RJBCircleFlowLayout *layout = [RJBCircleFlowLayout new];
        
        [self.collectionView setCollectionViewLayout:layout animated:YES];
    }else if ([self.collectionView.collectionViewLayout isKindOfClass:[RJBGridLayout class]]) {
        ...
        RJBGridLayout *layout = [RJBGridLayout new];
